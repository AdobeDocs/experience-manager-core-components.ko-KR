...
형식 탭에서는 기본 및 사용자 지정 날짜 형식을 지정할 수 있습니다. 또한 **추가** 단추를 사용하여 새 사용자 지정 숫자 형식을 추가할 수도 있습니다.
...
2. **허용된 구성 요소** 섹션에서 **[!UICONTROL 숫자 입력]** 구성 요소를 선택합니다.
   ![날짜 선택 템플릿 정책](/help/adaptive-forms/assets/number-input-policy.png)
3. 숫자 입력 구성 요소에 대한 새 정책을 만들려면 **[!UICONTROL 추가]** 아이콘을 클릭하십시오.
