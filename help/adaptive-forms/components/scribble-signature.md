---
title: 적응형 양식 핵심 구성 요소 - 스크리블 서명
description: 적응형 양식 스크리블 서명 핵심 구성 요소를 사용 또는 사용자 정의합니다.
...
![예](/help/adaptive-forms/assets/scribble-signature.png){width=50%,align-center}

**서명 창에서 사용 가능한 다양한 옵션**

- **A:** 캔버스에 서명을 그리려면 **그리기** 아이콘을 클릭합니다.
- **B:** 캔버스의 서명을 지우려면 **지우기** 아이콘을 클릭합니다.
- **C:** 서명과 함께 지리적 위치를 추가하려면 **지리적 위치** 아이콘을 클릭합니다.
- **D:** 키보드 **아이콘을 클릭하여 캔버스에 이름을 입력합니다.**

스크리블 서명 창에서 **저장** 아이콘을 선택하면 서명을 편집할 수 없습니다. 서명을 편집하고 싶은 경우, 현재 서명을 무시하고 위의 페인트 브러시/키보드 옵션을 사용하여 다시 서명해야 합니다.

>[!NOTE]
>
> 서명은 항상 PNG 형식으로 저장됩니다.

## 사용 {#reasons-to-use-scribble-signature}

양식에 스크리블 서명 필드를 포함하는 것이 유익한 몇 가지 이유는 다음과 같습니다.

- **디지털 동의**: 사용자가 법적으로 유효한 서명을 전자적으로 제공할 수 있도록 합니다.
- **향상된 사용자 경험**: 스캔이나 업로드 없이도 디바이스에서 바로 서명할 수 있는 자연스러운 방법을 제공합니다.
- **서류 없는 워크플로**: 문서를 인쇄하고, 서명하고, 다시 스캔할 필요가 없습니다.
- **인증**: 확인 및 승인을 위한 추가 계층 역할을 합니다.
- **데이터 정확성**: 서명자의 손으로 쓴 내용을 디지털 형태로 정확하게 캡처합니다.

## 버전 및 호환성 {#version-and-compatibility}

적응형 양식 스크리블 서명 핵심 구성 요소는 **2025년 8월**&#x200B;에 Cloud Service 이상을 위한 **핵심 구성 요소 2.24.6**&#x200B;의 일부로 출시되었습니다.
...
[GitHub](https://github.com/adobe/aem-core-forms-components)에서 적응형 양식 스크리블 서명 핵심 구성 요소에 대한 최신 기술 세부 정보를 확인하십시오. 핵심 구성 요소 개발에 대한 자세한 내용은 [핵심 구성 요소 개발자 설명서](/help/developing/overview.md)를 참조하십시오.

## 구성 대화 상자 {#configure-dialog}

구성 대화 상자를 사용하면 스크리블 서명 구성 요소를 사용자 정의할 수 있습니다.

### 기본 탭 {#basic-tab}

![기본 탭](/help/adaptive-forms/assets/scribble-signature-basictab.png)
...
- **서명 대화 제목**: 서명 대화 상자 제목은 서명 캡처 대화 상자 상단에 표시되는 텍스트를 정의합니다. 사용자가 서명을 해야 할 때 이는 프롬프트나 지시 역할을 합니다. 텍스트는 사용자가 서명 과정을 안내하는 데 도움이 되며, 상호 작용이 명확하고 직관적이게 됩니다.

### 유효성 검사 탭

![유효성 검사 탭](/help/adaptive-forms/assets/scribble-signature-validation.png)
...
![도움말 콘텐츠 탭](/help/adaptive-forms/assets/scribble-signature-helptab.png)
...
![접근성 탭](/help/adaptive-forms/assets/scribble-signature-accessibilitytab.png)
...
디자인 대화 상자는 스크리블 서명 구성 요소의 CSS 스타일을 정의하고 관리하는 데 사용됩니다.

### 스타일 탭 {#styles-tab}

탭은 구성 요소의 CSS 스타일을 정의하고 관리하는 데 사용됩니다. 적응형 양식 스크리블 서명 핵심 구성 요소는 AEM [스타일 시스템](/help/get-started/authoring.md#component-styling)을 지원합니다.

![디자인 대화 상자](/help/adaptive-forms/assets/checkbox-style.png)

- **기본 CSS 클래스**: 적응형 양식 스크리블 서명 핵심 구성 요소에 기본 CSS 클래스를 제공할 수 있습니다.
