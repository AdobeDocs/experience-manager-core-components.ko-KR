...
이 옵션을 사용하면 편집 모드에서 마법사를 추가할 때 기본적으로 표시되는 추가 단추를 클릭하여 적응형 양식 구성 요소를 추가할 수 있습니다.
...
다음 **허용된 구성 요소** 탭 을 사용하면 템플릿 편집기에서 항목으로 마법사 구성 요소의 패널에 추가할 수 있는 구성 요소를 적응형 Forms 편집기에서 설정할 수 있습니다.

### 스타일 탭 {#styles-tab}

디자인 대화 상자는 구성 요소의 CSS 스타일을 정의하고 관리하는 데 사용됩니다. 적응형 Forms 마법사 핵심 구성 요소는 AEM을 지원합니다 [스타일 시스템](/help/get-started/authoring.md#component-styling).

![스타일 탭](/help/adaptive-forms/assets/tabs-styles-tab.png)

- **기본 CSS 클래스**: 적응형 Forms 마법사 핵심 구성 요소에 기본 CSS 클래스를 제공할 수 있습니다.
