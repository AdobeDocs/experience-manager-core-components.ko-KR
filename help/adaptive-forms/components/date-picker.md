...
- **형식 오류 메시지** - 입력한 날짜의 형식이 올바르지 않을 때 화면에 표시되는 메시지를 입력할 수 있는 옵션입니다.
...
형식 탭에서는 기본 및 사용자 정의 날짜 형식을 지정할 수 있습니다. 또한 **추가** 버튼을 사용하여 새로운 사용자 정의 날짜 형식을 추가할 수도 있습니다.
...
2. **허용된 구성 요소** 섹션에서 **[!UICONTROL 날짜 선택기]** 구성 요소를 선택합니다.
   ![날짜 선택기 템플릿 정책](/help/adaptive-forms/assets/date-picker-policy.png)
3. **[!UICONTROL 추가]** 아이콘을 클릭하여 날짜 선택기 구성 요소에 대한 새 정책을 만듭니다.
