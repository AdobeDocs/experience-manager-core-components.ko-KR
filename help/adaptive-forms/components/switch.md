---
title: 적응형 Forms 핵심 구성 요소 - 스위치 구성 요소
description: 적응형 Forms 스위치 핵심 구성 요소 사용 또는 맞춤화
...
# 구성 요소 전환{#switch-adaptive-forms-core-component}

스위치 구성 요소는 사용자가 두 옵션 중에서 선택할 수 있는 양식에 사용되는 그래픽 사용자 인터페이스입니다. 일반적으로 기능, 설정 또는 기능을 활성화 또는 비활성화하는 두 가지 상태 중에서 선택할 수 있는 두 가지 상태 토글입니다. 스위치 컴포넌트는 현재 상태를 시각적으로 나타내고 특정 피쳐의 온 또는 오프 여부를 표시하도록 설계된다.

스위치 구성 요소는 값을 true 또는 false로 설정하는 부울 제어 요소입니다. 예를 들어 음소거 또는 음소거 해제, Bluetooth 또는 WiFi 활성화 또는 비활성화와 같은 기능을 켜거나 끄는 데 사용됩니다.

![구성 요소 전환 예](/help/adaptive-forms/assets/switch-example.png)

## 사용 {#reasons-to-use-switch}

적응형 양식에서 스위치를 사용해야 하는 일반적인 이유는 다음과 같습니다.

- **사용자 상호 작용**: 사용자는 스위치 구성 요소를 클릭하거나 탭하여 해당 구성 요소와 상호 작용할 수 있습니다.

- **상태**: 스위치 구성 요소의 상태는 ON과 OFF입니다. 스위치 구성 요소의 초기 상태는 기본 설정이나 제어하는 기능의 현재 상태에 따라 달라집니다.

- **시각적 표현**: 스위치 구성 요소는 색상이나 위치를 변경하여 현재 상태를 시각적으로 반영합니다.

- **제어 기능**: 스위치 구성 요소는 AEM Form에서 특정 기능을 활성화하거나 비활성화하는 데 사용됩니다. 예를 들어 사용자가 기능을 켜거나 끌 수 있습니다.

## 버전 및 호환성 {#version-and-compatibility}

적응형 Forms 스위치 핵심 구성 요소는 핵심 구성 요소 2.0.64의 일부로 릴리스되었습니다. 다음은 모든 지원되는 버전, AEM 호환성 및 해당 설명서에 대한 링크를 보여주는 표입니다.
...
의 기술 설명서에서 적응형 Forms 스위치 핵심 구성 요소에 대한 최신 정보를 알아보십시오 [GitHub](https://github.com/adobe/aem-core-forms-components/tree/master/ui.af.apps/src/main/content/jcr_root/apps/core/fd/components/form/switch/v1/switch). 핵심 구성 요소 개발에 대한 자세한 내용은 [핵심 구성 요소 개발자 설명서](/help/developing/overview.md)를 확인하십시오.

## 구성 대화 상자 {#configure-dialog}

구성 대화 상자를 통해 방문자에 대한 스위치 구성 요소 환경을 손쉽게 맞춤화할 수 있습니다. 또한 원활한 사용자 경험을 위해 쉽게 스위치 구성 요소 옵션을 정의할 수 있습니다.
...
- **선택 취소 상태 값 유지** - 이 옵션을 선택하면 스위치 구성 요소가 선택되지 않았을 때 반환되는 값을 지정할 수 있습니다.
- **옵션** - 각 옵션에 대한 데이터 값을 지정하고 텍스트를 표시합니다.
   - **데이터 값에서** - 스위치가 적응형 양식에서 활성화될 때 제출할 값을 지정합니다.
   - **표시 텍스트** - 적응형 양식에서 스위치가 활성화될 때 레이블로 표시할 텍스트를 지정합니다.
   - **데이터 값 해제** - 스위치가 적응형 양식에서 활성화되지 않을 때 제출할 값을 지정합니다. 이 옵션은 **선택 취소 상태 값 유지** 스위치가 활성화되었습니다.
   - **표시 해제 텍스트** - 스위치가 적응형 양식에서 활성화되지 않을 때 레이블로 표시할 텍스트를 지정합니다. 이 옵션은 **선택 취소 상태 값 유지** 스위치가 활성화되었습니다.
...
- **레이블 숨기기** - 스위치 구성 요소의 레이블을 숨기려면 이 옵션을 선택합니다.

- **레이블 표시** - 이 옵션을 선택하면 스위치 구성 요소의 레이블이 표시됩니다.

## 디자인 대화 상자 {#design-dialog}

디자인 대화 상자 를 통해 스위치 구성 요소의 CSS 스타일을 정의하고 관리할 수 있습니다.

### 스타일 탭 {#styles-design-tab}

적응형 Forms 스위치 핵심 구성 요소는 AEM을 지원합니다 [스타일 시스템](/help/get-started/authoring.md#component-styling).

![디자인 대화 상자](/help/adaptive-forms/assets/checkbox-style.png)

- **기본 CSS 클래스**: 적응형 Forms 스위치 그룹 핵심 구성 요소에 대한 기본 CSS 클래스를 제공할 수 있습니다.
