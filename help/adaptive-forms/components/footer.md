...
적응형 Forms 바닥글 핵심 구성 요소는 2023년 2월, Cloud Service의 경우 핵심 구성 요소 2.0.4, AEM 6.5.16.0 Forms 이상의 경우 핵심 구성 요소 1.1.12의 일부로 릴리스되었습니다. 다음 표에서는 지원되는 모든 버전, AEM 호환성 및 해당 문서에 대한 링크를 보여 줍니다.
