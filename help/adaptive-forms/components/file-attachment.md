...
# 첨부 파일 {#file-attachment-adaptive-forms-core-component}
...
적응형 양식에 첨부 파일 구성 요소를 포함하는 것이 유익한 몇 가지 이유는 다음과 같습니다.

* **추가 정보 수집**: 첨부 파일 구성 요소를 사용하면 문서, 이미지, 비디오 또는 기타 유형의 파일을 양식 제출의 일부로 업로드할 수 있습니다. 이는 이력서, 포트폴리오 또는 지원 문서와 같은 추가 정보를 수집하는 데 유용할 수 있습니다.

* **간편한 대용량 파일 공유**: 첨부 파일 구성 요소를 사용하면 외부 파일 공유 서비스에 의존하지 않고도 대용량 파일을 간편하게 공유할 수 있습니다.

* **편의성**: 첨부 파일 구성 요소를 사용하면 양식에서 벗어나거나 다른 도구를 사용하지 않고도 로컬 컴퓨터에서 파일을 업로드할 수 있습니다.

* **데이터 분석**: 첨부 파일 구성 요소를 사용하여 다양한 소스에서 데이터를 수집하고 분석하거나 추가 처리를 위한 입력으로 사용할 수 있습니다.

* **사용자 경험**: 첨부 파일 구성 요소를 사용하면 사용자가 명확하고 직관적으로 파일을 업로드할 수 있으므로 양식을 보다 사용자 친화적으로 만들 수 있습니다.
...
적응형 양식 첨부 파일 핵심 구성 요소에 대한 최신 정보는 [GitHub](https://github.com/adobe/aem-core-forms-components/tree/master/ui.af.apps/src/main/content/jcr_root/apps/core/fd/components/form/fileinput/v1/fileinput)의 기술 설명서에서 확인할 수 있습니다. 핵심 구성 요소 개발에 대한 자세한 내용은 [핵심 구성 요소 개발자 설명서](/help/developing/overview.md)를 확인하십시오.

## 구성 대화 상자 {#configure-dialog}

구성 대화 상자를 사용하여 방문자를 위한 첨부 파일 경험을 손쉽게 사용자 정의할 수 있습니다. 첨부 파일 옵션을 간편하게 정의하여 원활한 사용자 경험을 제공할 수도 있습니다.
...
* **버튼 제목** - 이 옵션은 적응형 양식에 표시되는 버튼의 레이블을 설정하는 데 사용됩니다.
...
* **파일 유형 오류 메시지** - 이 옵션을 사용하면 **허용된 파일 유형** 옵션에 나열된 것 이외의 파일 형식을 업로드할 경우 표시되는 오류 메시지를 입력할 수 있습니다.
...
![접근성 탭](/help/adaptive-forms/assets/fileattachement_accessibilitytab.png)
...
디자인 대화 상자는 첨부 파일 구성 요소의 CSS 스타일을 정의하고 관리하는 데 사용됩니다.

### 스타일 탭 {#styles-tab}

적응형 양식 첨부 파일 핵심 구성 요소는 AEM [스타일 시스템](/help/get-started/authoring.md#component-styling)을 지원합니다.

![파일 첨부 디자인 대화 상자](/help/adaptive-forms/assets/fileattachment_designdialog.png)

* **기본 CSS 클래스**: 적응형 양식 첨부 파일 핵심 구성 요소에 기본 CSS 클래스를 제공할 수 있습니다.
