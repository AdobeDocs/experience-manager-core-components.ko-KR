---
title: 응용 Forms 코어 구성 요소 - 전화 입력
description: 응용 Forms 전화 입력 코어 구성 요소 사용 또는 사용자 지정
...
# 전화 입력 {#telephone-input-adaptive-forms-core-component}

응용 양식 전화 입력 코어 구성 요소를 사용하여 사용자가 전화 번호를 입력할 수 있습니다. 전화 입력 필드는 전화 번호와 관련된 모바일 장치의 키보드를 표시합니다. 전화 번호의 형식과 설명을 지정하려면 &quot;패턴&quot; 및 &quot;자리 표시자&quot;와 같은 추가 속성을 사용하여 사용자 지정할 수 있습니다.

전화 입력 필드는 일반적으로 연락처 양식, 등록 양식 및 연락처 수단으로 전화 번호가 필요한 기타 양식에 사용됩니다. 상기 전화 입력 필드는 상기 &quot;pattern&quot; 속성을 기반으로 상기 전화번호의 길이 및 포맷과 같은 특정 제약조건을 적용할 수 있기 때문에 사용자가 유효한 전화번호를 입력하도록 하기 위해 사용될 수 있다.

## 사용 {#reasons-to-use-telephone-input}

적응형 양식에서 전화 입력 필드를 사용해야 하는 일반적인 이유는 다음과 같습니다.

* **연락처 정보**: 전화 입력 필드는 일반적으로 사용자의 전화 번호를 연락 수단으로 수집하는 데 사용됩니다.

* **데이터 정확도 개선**: 전화 입력 필드를 사용하면 양식에서 전화 번호 형식에 특정 제약 조건을 적용할 수 있으므로 입력된 데이터가 정확하고 완전한지 확인할 수 있습니다.

* **향상된 사용자 경험**: 전화 입력 필드는 사용자가 자신의 전화 번호를 입력할 수 있는 분명하고 직관적인 방법을 제공하며, 사용자가 자신의 연락처 정보를 빠르고 쉽게 입력할 수 있도록 하여 사용자 경험을 향상시킬 수 있다.

## 버전 및 호환성 {#version-and-compatibility}

응용 Forms 전화 입력 코어 구성 요소는 코어 구성 요소 2.0.4의 일부로 2023년 2월에 출시되었습니다. 다음은 지원되는 모든 버전, AEM 호환성 및 해당 설명서 링크를 보여주는 표입니다.
...
의 기술 설명서에서 응용 Forms 전화 입력 코어 구성 요소에 대한 최신 정보를 얻습니다. [GitHub](https://github.com/adobe/aem-core-forms-components/tree/master/ui.af.apps/src/main/content/jcr_root/apps/core/fd/components/form/telephoneinput/v1/telephoneinput). 핵심 구성 요소 개발에 대한 자세한 내용은 [핵심 구성 요소 개발자 설명서](/help/developing/overview.md).

## 구성 대화 상자 {#configure-dialog}

구성 대화 상자에서 방문자에 대한 전화 입력 경험을 쉽게 사용자 지정할 수 있습니다. 원활한 사용자 경험을 위해 전화 입력 옵션을 쉽게 정의할 수도 있습니다.
...
다음 **유효성 검사 패턴** 옵션을 사용하면 입력한 전화 번호를 확인할 패턴을 입력할 수 있습니다. 입력한 전화 번호는 **패턴** 선택 사항입니다. 전화 번호가 입력한 값으로 확인되지 않는 경우 **패턴** 옵션 , 화면에 오류 메시지가 표시됩니다.
* **패턴** - 이 옵션을 사용하면 전화 번호에 대해 허용되는 확인 패턴을 입력할 수 있습니다. 정규 표현식도 허용됩니다.
* **오류 메시지** - 이 옵션을 사용하면 입력한 전화 번호가 **패턴** 옵션
...
![액세스 가능성 탭](/help/adaptive-forms/assets/telephoneinput_accessibilitytab.png)
...
디자인 대화 상자는 전화 입력 구성 요소의 CSS 스타일을 정의하고 관리하는 데 사용됩니다.

### 스타일 탭 {#styles-tab}

디자인 대화 상자는 구성 요소의 CSS 스타일을 정의하고 관리하는 데 사용됩니다. 응용 Forms 전화 입력 코어 구성 요소는 AEM을 지원합니다 [스타일 시스템](/help/get-started/authoring.md#component-styling).

**기본 CSS 클래스**: 응용 Forms 전화 입력 코어 구성 요소에 기본 CSS 클래스를 제공할 수 있습니다.
