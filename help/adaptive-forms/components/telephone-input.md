...
![사용자 지정 속성 대화 상자](/help/adaptive-forms/assets/telephoneinput-customproperties.png)
...
### 검증 패턴 탭 {#validation-patterns-tab}

검증 패턴(Validation Pattern) 탭에서는 특정 형식의 값을 입력하거나 특정 기준을 충족할 수 있습니다. 일부 옵션은 기본적으로 사용할 수 있으며, 이 옵션은 해당 확인란을 선택하여 선택할 수 있습니다. 또한 **추가** 단추를 클릭합니다.
