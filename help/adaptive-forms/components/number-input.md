...
이 구성 요소를 사용하여 연령, 수량 등과 같은 수치 데이터를 수집할 수 있습니다. 또한 추가 및 빼기와 같은 수학 연산을 수행하는 데 사용할 수도 있습니다. 그리고 이 구성 요소를 사용하여 사용자가 입력한 숫자 데이터를 확인할 수도 있습니다.
...
* **수학 연산**: 숫자 필드를 사용하여 추가, 빼기, 곱하기 및 분할과 같은 수학 연산을 수행할 수 있습니다.
...
* **표시 형식** - 이 옵션을 사용하면 표시할 다른 정수 유형 포맷에서 옵션을 선택할 수 있습니다. 사용자가 **유형** 드롭다운 메뉴에서 옵션을 선택하면 패널에 **형식** 옵션이 표시됩니다. 숫자가 사용자에게 표시되는 특정 형식을 선택할 수 있습니다.
...
이 탭은 구성 요소에 대한 CSS 스타일을 정의하고 관리하는 데 사용됩니다. 적응형 양식 숫자 입력 핵심 구성 요소는 AEM [스타일 시스템](/help/get-started/authoring.md#component-styling)을 지원합니다.

![스티레타브](/help/adaptive-forms/assets/datepicker_styletab.png)
