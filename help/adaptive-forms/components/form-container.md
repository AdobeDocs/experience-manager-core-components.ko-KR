...
<span class="preview"> 이 문서에서는 시험판 기능인 **초안** 및 **햄버거 메뉴 지원** 기능에 대해 설명합니다. 이 프리릴리스 기능은 [프리릴리스 채널](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/prerelease.html?lang=ko#new-features)을 통해서만 액세스할 수 있습니다.</span>
