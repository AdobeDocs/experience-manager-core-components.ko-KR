...
적응형 Forms 확인란 핵심 구성 요소는 핵심 구성 요소 2.0.52의 일부로 릴리스되었습니다. 다음은 모든 지원되는 버전, AEM 호환성 및 해당 설명서에 대한 링크를 보여주는 표입니다.

|  |  |
|---|---|
| 구성 요소 버전 | AEM as a Cloud Service |
| --- | --- |
| v1 | 호환 가능 <br>[2.0.52](/help/versions.md) 및 이후 릴리스 | 호환 가능 | 호환 가능 |
...
- **선택 해제를 활성화합니다.**- 이전에 선택한 확인란을 선택 해제하는 기능을 활성화하거나 비활성화하려면 옵션을 선택합니다.
   - **선택 해제 활성화**&#x200B;를 활성화하거나 true로 설정하면 사용자가 재량에 따라 확인란을 선택하거나 선택 해제할 수 있습니다. 필요에 따라 확인란을 켜거나 끌 수 있습니다.

   - **선택 해제 활성화**&#x200B;를 비활성하거나 false로 설정하면 확인란이 선택된 후 사용자가 선택을 해제할 수 없습니다.
