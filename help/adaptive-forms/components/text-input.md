...
이 탭은 구성 요소에 대한 CSS 스타일을 정의하고 관리하는 데 사용됩니다. 적응형 양식 텍스트 상자 핵심 구성 요소는 AEM [스타일 시스템](/help/get-started/authoring.md#component-styling)을 지원합니다.
...
![서식 탭](/help/adaptive-forms/assets/telephoneinput_format.png)
