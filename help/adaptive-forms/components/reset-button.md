---
title: 응용 Forms 코어 구성 요소 - 재설정 단추
description: 응용 Forms 재설정 단추 코어 구성 요소 사용 또는 사용자 정의.
...
적응형 양식의 재설정 단추는 사용자가 모든 양식 필드를 기본값으로 지우거나 재설정할 수 있는 단추입니다. 재설정 단추를 클릭하면 양식 필드에 입력된 모든 데이터가 삭제되고 필드가 원래 상태로 돌아갑니다. 재설정 단추는 일반적으로 제출 단추의 대체 요소로 사용되며 사용자가 양식에 잘못되었거나 원하지 않는 데이터를 입력한 경우 다시 시작할 수 있는 방법을 제공합니다.


## 사용 {#reasons-to-use-reset-button}

적응형 양식에서 재설정 단추를 사용해야 하는 이유는 다음과 같습니다.

* **사용자 편의성**: 재설정 버튼을 사용하면 각 필드를 수동으로 삭제하지 않고도 빠르고 손쉽게 양식을 지우고 다시 시작할 수 있습니다.

* **유용성 개선**: 재설정 버튼을 사용하면 사용자가 실수를 쉽게 수정하거나 입력을 변경할 수 있어 사용자 경험을 향상시킬 수 있다.

* **오류 방지**: 재설정 단추를 사용하면 사용자가 실수로 잘못된 데이터를 제출하지 않을 수 있으므로 오류나 처리 문제가 발생할 수 있습니다.

* **일관성**: 재설정 단추를 양식에 포함하면 양식의 일반적인 기능이므로 사용자 경험에서 일관됩니다.

* **데이터 관리 개선**: 재설정 단추를 사용하면, 사용자가 일관되지 않거나 잘못된 데이터를 제출할 가능성이 적으므로 양식 데이터를 구성 및 정확하게 유지할 수 있습니다.

## 버전 및 호환성 {#version-and-compatibility}

응용 Forms 재설정 단추 코어 구성 요소는 코어 구성 요소 2.0.4의 일부로 2023년 2월에 출시되었습니다. 다음은 지원되는 모든 버전, AEM 호환성 및 해당 설명서 링크를 보여주는 표입니다.
...
의 기술 설명서에서 응용 Forms 재설정 단추 코어 구성 요소에 대한 최신 정보를 가져옵니다 [GitHub](https://github.com/adobe/aem-core-forms-components/tree/master/ui.af.apps/src/main/content/jcr_root/apps/core/fd/components/form/button/v1/button). 핵심 구성 요소 개발에 대한 자세한 내용은 [핵심 구성 요소 개발자 설명서](/help/developing/overview.md).

## 구성 대화 상자 {#configure-dialog}

구성 대화 상자에서 방문자에 대한 재설정 단추 경험을 쉽게 사용자 지정할 수 있습니다. 원활한 사용자 경험을 위해 재설정 단추 옵션을 쉽게 정의할 수도 있습니다.
...
디자인 대화 상자는 재설정 단추 구성 요소의 CSS 스타일을 정의하고 관리하는 데 사용됩니다.


### 스타일 탭 {#styles-tab}

디자인 대화 상자는 구성 요소의 CSS 스타일을 정의하고 관리하는 데 사용됩니다. 응용 Forms 재설정 단추 코어 구성 요소는 AEM을 지원합니다 [스타일 시스템](/help/get-started/authoring.md#component-styling).

**기본 CSS 클래스**: 응용 Forms 재설정 단추 코어 구성 요소에 대한 기본 CSS 클래스를 제공할 수 있습니다.
