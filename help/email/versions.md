...
|---|---|---|---|---|---|---|
| [1.3.0](https://github.com/adobe/aem-core-email-components/releases/tag/core.email.components.reactor-1.3.0) | 이 릴리스는 포함된 jsup 라이브러리를 업데이트합니다. | 6.5.14.0+ | 6.5LTS GA | [2.21.2+](/help/versions.md) | 8, 11 | 2024년 6월 28일 |
