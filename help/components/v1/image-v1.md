...
템플릿 작성자는 [디자인 대화 상자에서 허용된 이미지 폭과 자르기 및 추가 설정을 정의할 수 있습니다](#design-dialog). 콘텐츠 편집기는 구성 대화 상자에서 자산을 [업로드 또는 선택하고](#configure-dialog) 편집 대화 상자에서 [이미지를](#edit-dialog)자를 수 있습니다. 또한 편의성을 높이기 위해 이미지를 직접 간단하게 수정할 수 있습니다.
...
>[!NOTE]
>
>핵심 구성 요소에서 JSON 내보내기를 사용하려면 핵심 구성 요소의 릴리스 1.1.0이 필요합니다. 자세한 내용은 핵심 구성 요소 v1 [](/help/versions.md) 호환성 정보를 참조하십시오.
...
* **이미지 자산**
   ...
   * 자산 편집기에서 자산 **의** 표현물을 [관리하려면](https://helpx.adobe.com/experience-manager/6-3/assets/using/managing-assets-touch-ui.html#main-pars_title_19) 또는 편집을 클릭합니다.
...
* **캡션을 팝업으로** 표시 - 이 확인란을 선택하면 캡션이 이미지 아래에 표시되지 않고 이미지 위로 마우스를 가져가면 일부 브라우저가 팝업으로 표시하는 것입니다.
