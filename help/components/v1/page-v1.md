...
페이지 구성 요소는 [템플릿 편집기](https://helpx.adobe.com/experience-manager/6-4/sites/authoring/using/templates.html)에서 작업하고 페이지 머리글/바닥글 및 구조 구성 요소를 템플릿 편집기로 어셈블할 수 있도록 디자인된 확장 가능한 페이지 구성 요소입니다.

## 사용량 {#usage}

페이지 구성 요소는 편집 가능한 템플릿과 핵심 구성 요소로 디자인된 모든 페이지의 기준을 형성합니다. 페이지 구성 요소, 머리글, 바닥글 및 페이지의 구조는 다른 핵심 구성 요소를 사용하여 템플릿으로 정의할 수 있습니다.

[디자인 대화 상자](#design-dialog)를 사용하여 페이지에 대해 사용자 지정 클라이언트측 라이브러리를 정의할 수 있습니다. 구성 요소가 페이지 자체이므로 구성 요소에서 직접 액세스할 수 있는 편집 대화 상자가 있는 다른 구성 요소와 달리, 페이지 구성 요소의 [편집 대화 상자](#edit-dialog)는 페이지 속성 창입니다.

## 버전 및 호환성 {#version-and-compatibility}

이 문서에서는 원래 AEM 6.3과 함께 코어 구성 요소 릴리스 1.0.0에 소개된 페이지 구성 요소의 v1에 대해 설명합니다.

다음 표에는 페이지 구성 요소 v1의 호환성이 나와 있습니다.
...
>[!NOTE]
>
>페이지 구성 요소의 v1은 페이지 리디렉션을 지원하지 않습니다. 페이지 리디렉션 지원을 위해 [페이지 구성 요소의 현재 버전](/help/components/page.md)을 사용하십시오.
...
페이지 디자인 창에서 페이지와 함께 로드해야 하는 클라이언트 측 라이브러리를 정의할 수 있습니다.
...
클라이언트측 라이브러리 사용에 대한 자세한 내용은 [클라이언트 측 라이브러리 사용](https://helpx.adobe.com/experience-manager/6-3/sites/developing/using/clientlibs.html)을 참조하십시오.

![](/help/assets/chlimage_1-95.png)

## 기술 세부 정보 {#technical-details}

페이지 구성 요소 [에 대한 최신 기술 설명서는 GitHub](https://github.com/adobe/aem-core-wcm-components/tree/master/content/src/content/jcr_root/apps/core/wcm/components/page/v1/page)에 있습니다.
