...
목록 구성 요소를 사용하여 하위 페이지의 동적 목록 또는 임의로 정의된 항목의 정적 목록 등을 만들 수 있습니다.

사용 가능한 목록 및 서식 지정 옵션 유형은 [디자인 대화 상자](#design-dialog)에서 템플릿 작성자가 정의할 수 있습니다. 콘텐츠 편집기는 사용 가능한 목록 유형 중에서 선택할 수 있으며 [편집 대화 상자](#edit-dialog)에서 목록 요소의 형식을 지정하는 방법을 선택할 수 있습니다.
...
목록에 새 항목을 삽입하려면 **추가** 단추를 누르거나 클릭합니다.
...
* **정적**  목록 비활성화 - 구성 요소에서 정적 목록 유형을 비활성화합니다.
...
* **날짜 표시**  -  [편집 대화 상자에서 날짜 표시 활성화 옵션 사용](#edit-dialog)
