...
사용 가능한 목록 유형 및 서식 지정 옵션은 [디자인 대화 상자에서](#design-dialog)템플릿 작성자가 정의할 수 있습니다. 컨텐츠 편집기는 사용 가능한 목록 유형 및 [편집 대화](#edit-dialog)상자에서 목록 요소의 서식을 지정하는 방법을 선택할 수 있습니다.
...
>
>목록 구성 요소의 현재 버전에 대한 자세한 내용은 목록 구성 요소 [문서를](/help/components/list.md) 참조하십시오.
