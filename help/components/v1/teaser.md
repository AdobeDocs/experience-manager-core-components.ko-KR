...
이 문서에서는 2018년 7월에 핵심 구성 요소 릴리스 2.1.0과 함께 소개된 Teaser 구성 요소의 v1에 대해 설명합니다.

>[!CAUTION]
>
>이 문서에서는 Teaser 구성 요소의 v1에 대해 설명합니다.
>
>티저 구성 요소의 현재 버전에 대한 자세한 내용은 [티저 구성 요소](/help/components/teaser.md) 문서.
...
티저 구성 요소는 이미지 렌더링을 [이미지 구성 요소](image-v1.md)로 전달합니다. 따라서 [대화 상자 편집]컨텐츠 작성자가 티저 이미지를 조작하는 데 이미지 구성 요소의 image-v1.md#edit-dialog 를 사용할 수 있습니다.
