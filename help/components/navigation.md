---
title: 탐색 구성 요소
description: 탐색 구성 요소를 사용하면 글로벌화된 사이트 구조를 쉽게 탐색할 수 있습니다.
...
탐색 구성 요소뿐만 아니라 구성 옵션의 예와 HTML 및 JSON 출력을 보려면 구성 요소 [라이브러리를 참조하십시오](https://adobe.com/go/aem_cmp_library_navigation).
