...
목록 구성 요소의 현재 버전은 v2이며, 2018년 1월에 핵심 구성 요소 릴리스 2.0.0에서 도입되었으며, 이 문서에 설명되어 있습니다.
...
목록 구성 요소를 경험하고 구성 옵션의 예와 HTML 및 JSON 출력을 보려면 [구성 요소 라이브러리](https://adobe.com/go/aem_cmp_library_list)를 방문하십시오.

### 기술 세부 정보 {#technical-details}

목록 구성 요소 [에 대한 최신 기술 설명서는 GitHub](https://adobe.com/go/aem_cmp_tech_list_v2)에 있습니다.
...
목록이 어떻게 만들어지는지에 관계없이 항상 구성할 수 있는 [정렬 및 ID 옵션](#sort-options)이 있습니다.
...
* **검색**
쿼리전체 텍스트 검색을 실행하여 목록 요소를 생성할 문자열입니다
* **검색**
에서 검색을 실행해야 하는 위치
...
* ****
일치목록에 포함할 페이지에 적합한 일치 유형을 정의합니다
   * **임의의 태그**
   * **모든 태그**
...
* **날짜**
형식마지막 수정 날짜 표시에 사용할 형식입니다
* **하위**
항목 비활성화구성 요소에서 하위 목록 유형을 비활성화합니다
* **static**
구성 요소에서 정적 목록 유형을 비활성화합니다
* **검색**
비활성화구성 요소에서 검색 목록 유형을 비활성화합니다
* **태그**
...
* **링크**
항목  [편집 대화 상자에서 링크 항목 활성화 옵션](#edit-dialog)
* **설명**
표시편집 대화 상자에서 설명 표시  [옵션 사용](#edit-dialog)
* **편집**
대화 상자에서 날짜 표시  [활성화 옵션](#edit-dialog)
