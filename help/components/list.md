...
목록 구성 요소를 사용하여 하위 페이지의 동적 목록 또는 임의로 정의된 항목의 정적 목록 등을 만들 수 있습니다. 사용 가능한 목록 및 서식 지정 옵션 유형은 [디자인 대화 상자](#design-dialog)에서 템플릿 작성자가 정의할 수 있습니다. 콘텐츠 편집기는 사용 가능한 목록 유형 중에서 선택할 수 있으며 [편집 대화 상자](#edit-dialog)에서 목록 요소의 형식을 지정하는 방법을 선택할 수 있습니다.
...
목록 구성 요소뿐만 아니라 구성 옵션의 예와 HTML 및 JSON 출력을 보려면 [구성 요소 라이브러리](https://adobe.com/go/aem_cmp_library_list)를 방문하십시오.
...
* **하위**
깊이계층 구조에서 하위 수준을 얼마나 많이 사용해야 합니까?
...
* **날짜**
표시편집 대화  [상자에서 날짜 표시 사용 옵션](#edit-dialog)
