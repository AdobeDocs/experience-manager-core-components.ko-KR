...
* 에서 **링크** 필드 입력
   * 정규화된 URL
   * 기존 AEM 컨텐츠에 대한 상대 URL
      * 를 사용할 수 있습니다 **선택 대화 상자** AEM에서 항목을 선택하려면 다음을 수행하십시오.
* 에서 **텍스트** 필드, 목록에 링크에 표시할 텍스트를 입력합니다.
* 링크가 새 브라우저 탭에서 열려야 하는 경우에는 확인란을 선택합니다

목록에 대해 두 개 이상의 항목이 만들어지면 목록을 정렬할 수 있습니다.
