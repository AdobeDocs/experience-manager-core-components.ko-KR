...
현재 버전의 목록 구성 요소는 2023년 2월 핵심 구성 요소 릴리스 2.22.0과 함께 도입된 v4입니다. 이 문서에서는 해당 구성 요소에 대해 설명합니다.
...
* **링크** 필드에 다음 중 하나를 입력합니다.
   * 정규화된 URL
   * 기존 AEM 콘텐츠에 대한 상대 URL
      * **선택 대화 상자**&#x200B;를 사용하여 AEM에서 항목을 선택할 수 있습니다.
* **텍스트** 필드에 목록의 링크에 표시할 텍스트를 입력합니다.
* 링크가 새 브라우저 탭에서 열리도록 하려면 확인란을 선택합니다.

목록에 대해 두 개 이상의 항목이 생성되면 목록을 정렬할 수 있습니다.
...
![항목 설정](/help/assets/list-edit-item-settings.png)
...
![목록 구성 요소의 편집 대화 상자 스타일 탭](/help/assets/list-edit-styles.png)
