...
목록 구성 요소에 대한 최신 기술 설명서는[ GitHub에서 확인할 수 있습니다](https://adobe.com/go/aem_cmp_tech_list_v2_kr).
...
* **검색 쿼리**
텍스트 검색에 대한 문자열을 실행하여 목록 요소를 생성합니다.
* **검색 영역**
검색이 실행되는 위치
...
* **링크 항목**
[편집 대화 상자](#edit-dialog)에서 링크 항목 옵션을 활성화합니다.
* **설명 표시**
[편집 대화 상자](#edit-dialog)에서 설명 표시 옵션을 활성화합니다.
* **날짜 표시**
