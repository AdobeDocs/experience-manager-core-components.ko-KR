...
향후 핵심 구성 요소 로드맵에 대한 개요는 Github의 [Project Wiki를](https://github.com/adobe/aem-core-wcm-components/wiki/home)참조하십시오.
...
이러한 도구의 사용에 대한 자세한 내용은 해당 [설명서를](http://opensource.adobe.com/aem-modernize-tools/)참조하십시오.
