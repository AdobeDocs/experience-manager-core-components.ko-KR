...
전체 화면 편집 대화 상자에서 사용할 수 있는 모든 기능을 갖춘 제한된 옵션을 사용하여 [편집 대화 상자를](text-v1.md#main-pars_title) 바로 편집할 수 있습니다. 제목, 특수 문자 및 단락 스타일과 같은 [텍스트 서식 지정 옵션은](text-v1.md#main-pars_title_1995166862)디자인 대화상자를 사용하여 내용 작성자를 위한 템플릿에 구성할 수 있습니다.
