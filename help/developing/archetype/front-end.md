...
[AEM clientlib.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/full-stack/clientlibs.html)을(를) 사용하여 프론트엔드 모듈을 사용할 수 있습니다. NPM 빌드 스크립트를 실행하면 앱이 빌드되고 `aem-clientlib-generator` 패키지는 결과 빌드 출력을 가져와 clientlib으로 변환합니다.
