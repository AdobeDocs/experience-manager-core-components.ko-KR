...
* **다음 튜토리얼은 Archetype에 따라 작성됩니다.**
   ...
   * **[WKND Single Page App:](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/spa-editor/spa-editor-framework-feature-video-use.html)** - AEM에서 전체 작성할 수 있는 React 또는 Angular WebApp을 빌드하는 방법에 알아봅니다.
